    ...
    return (
        ...
        <div className="hero-content flex-col lg:flex-row">
            <div className='lg:w-1/2 relative'>
                ...
                <img src={perts} className="max-w-sm absolute border-8 border-white top-1/2 right-10 rounded-lg shadow-2xl"/>
            </div>

            <div className='lg:w-1/2 space-y-7 p-4'>
                <h3 className='text-3xl font-bold text-orange-500 font-bold'>About Us</h3>
